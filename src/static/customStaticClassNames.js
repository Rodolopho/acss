...
"pr20px":"padding-right:20px",
 ...
 //Some shades
 'color-primary-darkest':"color:hsla(210,43%,24%,1)",
	'color-primary-darker':"color:hsla(211,59%,29%,1)",
	'color-primary-dark':"color:hsla(211,61%,41%,1)",
	'color-primary':"color:hsla(211,60%,51%,1)",
	'color-primary-light':"color:hsla(210,63%,63%,1)",
	'color-primary-lighter':"color:hsla(209,84%,82%,1)",
	'color-primary-lightest':"color:hsla(206,100%,97%,1)",

	'color-darkest':"color:hsla(218,22%,17%,1)",
	'color-darker':"color:hsla(216,13%,43%,1)",
	'color-dark':"color:hsla(218,16%,60%,1)",
	'color-grey':"color:hsla(210,19%,77%,1)",
	'color-light':"color:hsla(214,20%,84%,1)",
	'color-lighter':"color:hsla(210,25%,91%,1)",
	'color-lightest':"color:hsla(210,17%,98%,1)",

	'color-info-darkest':"color:hsla(179,50%,18%,1)",
	'color-info-darker':"color:hsla(174,48%,26%,1)",
	'color-info-dark':"color:hsla(173,46%,39%,1)",
	'color-info':"color:hsla(173,42%,48%,1)",
	'color-info-light':"color:hsla(178,55%,65%,1)",
	'color-info-lighter':"color:hsla(177,66%,80%,1)",
	'color-info-lightest':"color:hsla(177,100%,95%,1)",

	'color-success-darkest':"color:hsla(149,50%,21%,1)",
	'color-success-darker':"color:hsla(135,53%,31%,1)",
	'color-success-dark':"color:hsla(135,50%,41%,1)",
	'color-success':"color:hsla(135,50%,52%,1)",
	'color-success-light':"color:hsla(138,56%,67%,1)",
	'color-success-lighter':"color:hsla(135,66%,80%,1)",
	'color-success-lightest':"color:hsla(137,80%,94%,1)",


	'color-warning-darkest':"color:hsla(47,100%,18%,1)",
	'color-warning-darker':"color:hsla(47,100%,27%,1)",
	'color-warning-dark':"color:hsla(48,75%,45%,1)",
	'color-warning':"color:hsla(46,86%,63%,1)",
	'color-warning-light':"color:hsla(47,89%,78%,1)",
	'color-warning-lighter':"color:hsla(47,91%,91%,1)",
	'color-warning-lightest':"color:hsla(45,100%,98%,1)",

	'color-danger-darkest':"color:hsla(2,62%,23%,1)",
	'color-danger-darker':"color:hsla(3,71%,31%,1)",
	'color-danger-dark':"color:hsla(4,75%,40%,1)",
	'color-danger':"color:hsla(3,69%,51%,1)",
	'color-danger-light':"color:hsla(2,67%,63%,1)",
	'color-danger-lighter':"color:hsla(2,74%,81%,1)",
	'color-danger-lightest':"color:hsla(0,70%,95%,1)",
	//--back

	'background-color-primary-darkest':"background-color:hsla(210,43%,24%,1)",
	'background-color-primary-darker':"background-color:hsla(211,59%,29%,1)",
	'background-color-primary-dark':"background-color:hsla(211,61%,41%,1)",
	'background-color-primary':"background-color:hsla(211,60%,51%,1)",
	'background-color-primary-light':"background-color:hsla(210,63%,63%,1)",
	'background-color-primary-lighter':"background-color:hsla(209,84%,82%,1)",
	'background-color-primary-lightest':"background-color:hsla(206,100%,97%,1)",

	'background-color-darkest':"background-color:hsla(218,22%,17%,1)",
	'background-color-darker':"background-color:hsla(216,13%,43%,1)",
	'background-color-dark':"background-color:hsla(218,16%,60%,1)",
	'background-color-grey':"background-color:hsla(210,19%,77%,1)",
	'background-color-light':"background-color:hsla(214,20%,84%,1)",
	'background-color-lighter':"background-color:hsla(210,25%,91%,1)",
	'background-color-lightest':"background-color:hsla(210,17%,98%,1)",

	'background-color-info-darkest':"background-color:hsla(179,50%,18%,1)",
	'background-color-info-darker':"background-color:hsla(174,48%,26%,1)",
	'background-color-info-dark':"background-color:hsla(173,46%,39%,1)",
	'background-color-info':"background-color:hsla(173,42%,48%,1)",
	'background-color-info-light':"background-color:hsla(178,55%,65%,1)",
	'background-color-info-lighter':"background-color:hsla(177,66%,80%,1)",
	'background-color-info-lightest':"background-color:hsla(177,100%,95%,1)",

	'background-color-success-darkest':"background-color:hsla(149,50%,21%,1)",
	'background-color-success-darker':"background-color:hsla(135,53%,31%,1)",
	'background-color-success-dark':"background-color:hsla(135,50%,41%,1)",
	'background-color-success':"background-color:hsla(135,50%,52%,1)",
	'background-color-success-light':"background-color:hsla(138,56%,67%,1)",
	'background-color-success-lighter':"background-color:hsla(135,66%,80%,1)",
	'background-color-success-lightest':"background-color:hsla(137,80%,94%,1)",


	'background-color-warning-darkest':"background-color:hsla(47,100%,18%,1)",
	'background-color-warning-darker':"background-color:hsla(47,100%,27%,1)",
	'background-color-warning-dark':"background-color:hsla(48,75%,45%,1)",
	'background-color-warning':"background-color:hsla(46,86%,63%,1)",
	'background-color-warning-light':"background-color:hsla(47,89%,78%,1)",
	'background-color-warning-lighter':"background-color:hsla(47,91%,91%,1)",
	'background-color-warning-lightest':"background-color:hsla(45,100%,98%,1)",

	'background-color-danger-darkest':"background-color:hsla(2,62%,23%,1)",
	'background-color-danger-darker':"background-color:hsla(3,71%,31%,1)",
	'background-color-danger-dark':"background-color:hsla(4,75%,40%,1)",
	'background-color-danger':"background-color:hsla(3,69%,51%,1)",
	'background-color-danger-light':"background-color:hsla(2,67%,63%,1)",
	'background-color-danger-lighter':"background-color:hsla(2,74%,81%,1)",
	'background-color-danger-lightest':"background-color:hsla(0,70%,95%,1)",
	// border

	'border-color-primary-darkest':"border-color:hsla(210,43%,24%,1)",
	'border-color-primary-darker':"border-color:hsla(211,59%,29%,1)",
	'border-color-primary-dark':"border-color:hsla(211,61%,41%,1)",
	'border-color-primary':"border-color:hsla(211,60%,51%,1)",
	'border-color-primary-light':"border-color:hsla(210,63%,63%,1)",
	'border-color-primary-lighter':"border-color:hsla(209,84%,82%,1)",
	'border-color-primary-lightest':"border-color:hsla(206,100%,97%,1)",

	'border-color-darkest':"border-color:hsla(218,22%,17%,1)",
	'border-color-darker':"border-color:hsla(216,13%,43%,1)",
	'border-color-dark':"border-color:hsla(218,16%,60%,1)",
	'border-color-grey':"border-color:hsla(210,19%,77%,1)",
	'border-color-light':"border-color:hsla(214,20%,84%,1)",
	'border-color-lighter':"border-color:hsla(210,25%,91%,1)",
	'border-color-lightest':"border-color:hsla(210,17%,98%,1)",

	'border-color-info-darkest':"border-color:hsla(179,50%,18%,1)",
	'border-color-info-darker':"border-color:hsla(174,48%,26%,1)",
	'border-color-info-dark':"border-color:hsla(173,46%,39%,1)",
	'border-color-info':"border-color:hsla(173,42%,48%,1)",
	'border-color-info-light':"border-color:hsla(178,55%,65%,1)",
	'border-color-info-lighter':"border-color:hsla(177,66%,80%,1)",
	'border-color-info-lightest':"border-color:hsla(177,100%,95%,1)",

	'border-color-success-darkest':"border-color:hsla(149,50%,21%,1)",
	'border-color-success-darker':"border-color:hsla(135,53%,31%,1)",
	'border-color-success-dark':"border-color:hsla(135,50%,41%,1)",
	'border-color-success':"border-color:hsla(135,50%,52%,1)",
	'border-color-success-light':"border-color:hsla(138,56%,67%,1)",
	'border-color-success-lighter':"border-color:hsla(135,66%,80%,1)",
	'border-color-success-lightest':"border-color:hsla(137,80%,94%,1)",


	'border-color-warning-darkest':"border-color:hsla(47,100%,18%,1)",
	'border-color-warning-darker':"border-color:hsla(47,100%,27%,1)",
	'border-color-warning-dark':"border-color:hsla(48,75%,45%,1)",
	'border-color-warning':"border-color:hsla(46,86%,63%,1)",
	'border-color-warning-light':"border-color:hsla(47,89%,78%,1)",
	'border-color-warning-lighter':"border-color:hsla(47,91%,91%,1)",
	'border-color-warning-lightest':"border-color:hsla(45,100%,98%,1)",

	'border-color-danger-darkest':"border-color:hsla(2,62%,23%,1)",
	'border-color-danger-darker':"border-color:hsla(3,71%,31%,1)",
	'border-color-danger-dark':"border-color:hsla(4,75%,40%,1)",
	'border-color-danger':"border-color:hsla(3,69%,51%,1)",
	'border-color-danger-light':"border-color:hsla(2,67%,63%,1)",
	'border-color-danger-lighter':"border-color:hsla(2,74%,81%,1)",
	'border-color-danger-lightest':"border-color:hsla(0,70%,95%,1)",


	//shothand
	'c_primary-darkest':"color:hsla(210,43%,24%,1)",
	'c_primary-darker':"color:hsla(211,59%,29%,1)",
	'c_primary-dark':"color:hsla(211,61%,41%,1)",
	'c_primary':"color:hsla(211,60%,51%,1)",
	'c_primary-light':"color:hsla(210,63%,63%,1)",
	'c_primary-lighter':"color:hsla(209,84%,82%,1)",
	'c_primary-lightest':"color:hsla(206,100%,97%,1)",

	'c_darkest':"color:hsla(218,22%,17%,1)",
	'c_darker':"color:hsla(216,13%,43%,1)",
	'c_dark':"color:hsla(218,16%,60%,1)",
	'c_grey':"color:hsla(210,19%,77%,1)",
	'c_light':"color:hsla(214,20%,84%,1)",
	'c_lighter':"color:hsla(210,25%,91%,1)",
	'c_lightest':"color:hsla(210,17%,98%,1)",

	'c_info-darkest':"color:hsla(179,50%,18%,1)",
	'c_info-darker':"color:hsla(174,48%,26%,1)",
	'c_info-dark':"color:hsla(173,46%,39%,1)",
	'c_info':"color:hsla(173,42%,48%,1)",
	'c_info-light':"color:hsla(178,55%,65%,1)",
	'c_info-lighter':"color:hsla(177,66%,80%,1)",
	'c_info-lightest':"color:hsla(177,100%,95%,1)",

	'c_success-darkest':"color:hsla(149,50%,21%,1)",
	'c_success-darker':"color:hsla(135,53%,31%,1)",
	'c_success-dark':"color:hsla(135,50%,41%,1)",
	'c_success':"color:hsla(135,50%,52%,1)",
	'c_success-light':"color:hsla(138,56%,67%,1)",
	'c_success-lighter':"color:hsla(135,66%,80%,1)",
	'c_success-lightest':"color:hsla(137,80%,94%,1)",


	'c_warning-darkest':"color:hsla(47,100%,18%,1)",
	'c_warning-darker':"color:hsla(47,100%,27%,1)",
	'c_warning-dark':"color:hsla(48,75%,45%,1)",
	'c_warning':"color:hsla(46,86%,63%,1)",
	'c_warning-light':"color:hsla(47,89%,78%,1)",
	'c_warning-lighter':"color:hsla(47,91%,91%,1)",
	'c_warning-lightest':"color:hsla(45,100%,98%,1)",

	'c_danger-darkest':"color:hsla(2,62%,23%,1)",
	'c_danger-darker':"color:hsla(3,71%,31%,1)",
	'c_danger-dark':"color:hsla(4,75%,40%,1)",
	'c_danger':"color:hsla(3,69%,51%,1)",
	'c_danger-light':"color:hsla(2,67%,63%,1)",
	'c_danger-lighter':"color:hsla(2,74%,81%,1)",
	'c_danger-lightest':"color:hsla(0,70%,95%,1)",
	//--back

	'bgc_primary-darkest':"background-color:hsla(210,43%,24%,1)",
	'bgc_primary-darker':"background-color:hsla(211,59%,29%,1)",
	'bgc_primary-dark':"background-color:hsla(211,61%,41%,1)",
	'bgc_primary':"background-color:hsla(211,60%,51%,1)",
	'bgc_primary-light':"background-color:hsla(210,63%,63%,1)",
	'bgc_primary-lighter':"background-color:hsla(209,84%,82%,1)",
	'bgc_primary-lightest':"background-color:hsla(206,100%,97%,1)",

	'bgc_darkest':"background-color:hsla(218,22%,17%,1)",
	'bgc_darker':"background-color:hsla(216,13%,43%,1)",
	'bgc_dark':"background-color:hsla(218,16%,60%,1)",
	'bgc_grey':"background-color:hsla(210,19%,77%,1)",
	'bgc_light':"background-color:hsla(214,20%,84%,1)",
	'bgc_lighter':"background-color:hsla(210,25%,91%,1)",
	'bgc_lightest':"background-color:hsla(210,17%,98%,1)",

	'bgc_info-darkest':"background-color:hsla(179,50%,18%,1)",
	'bgc_info-darker':"background-color:hsla(174,48%,26%,1)",
	'bgc_info-dark':"background-color:hsla(173,46%,39%,1)",
	'bgc_info':"background-color:hsla(173,42%,48%,1)",
	'bgc_info-light':"background-color:hsla(178,55%,65%,1)",
	'bgc_info-lighter':"background-color:hsla(177,66%,80%,1)",
	'bgc_info-lightest':"background-color:hsla(177,100%,95%,1)",

	'bgc_success-darkest':"background-color:hsla(149,50%,21%,1)",
	'bgc_success-darker':"background-color:hsla(135,53%,31%,1)",
	'bgc_success-dark':"background-color:hsla(135,50%,41%,1)",
	'bgc_success':"background-color:hsla(135,50%,52%,1)",
	'bgc_success-light':"background-color:hsla(138,56%,67%,1)",
	'bgc_success-lighter':"background-color:hsla(135,66%,80%,1)",
	'bgc_success-lightest':"background-color:hsla(137,80%,94%,1)",


	'bgc_warning-darkest':"background-color:hsla(47,100%,18%,1)",
	'bgc_warning-darker':"background-color:hsla(47,100%,27%,1)",
	'bgc_warning-dark':"background-color:hsla(48,75%,45%,1)",
	'bgc_warning':"background-color:hsla(46,86%,63%,1)",
	'bgc_warning-light':"background-color:hsla(47,89%,78%,1)",
	'bgc_warning-lighter':"background-color:hsla(47,91%,91%,1)",
	'bgc_warning-lightest':"background-color:hsla(45,100%,98%,1)",

	'bgc_danger-darkest':"background-color:hsla(2,62%,23%,1)",
	'bgc_danger-darker':"background-color:hsla(3,71%,31%,1)",
	'bgc_danger-dark':"background-color:hsla(4,75%,40%,1)",
	'bgc_danger':"background-color:hsla(3,69%,51%,1)",
	'bgc_danger-light':"background-color:hsla(2,67%,63%,1)",
	'bgc_danger-lighter':"background-color:hsla(2,74%,81%,1)",
	'bgc_danger-lightest':"background-color:hsla(0,70%,95%,1)",
	// border

	'bc_primary-darkest':"border-color:hsla(210,43%,24%,1)",
	'bc_primary-darker':"border-color:hsla(211,59%,29%,1)",
	'bc_primary-dark':"border-color:hsla(211,61%,41%,1)",
	'bc_primary':"border-color:hsla(211,60%,51%,1)",
	'bc_primary-light':"border-color:hsla(210,63%,63%,1)",
	'bc_primary-lighter':"border-color:hsla(209,84%,82%,1)",
	'bc_primary-lightest':"border-color:hsla(206,100%,97%,1)",

	'bc_darkest':"border-color:hsla(218,22%,17%,1)",
	'bc_darker':"border-color:hsla(216,13%,43%,1)",
	'bc_dark':"border-color:hsla(218,16%,60%,1)",
	'bc_grey':"border-color:hsla(210,19%,77%,1)",
	'bc_light':"border-color:hsla(214,20%,84%,1)",
	'bc_lighter':"border-color:hsla(210,25%,91%,1)",
	'bc_lightest':"border-color:hsla(210,17%,98%,1)",

	'bc_info-darkest':"border-color:hsla(179,50%,18%,1)",
	'bc_info-darker':"border-color:hsla(174,48%,26%,1)",
	'bc_info-dark':"border-color:hsla(173,46%,39%,1)",
	'bc_info':"border-color:hsla(173,42%,48%,1)",
	'bc_info-light':"border-color:hsla(178,55%,65%,1)",
	'bc_info-lighter':"border-color:hsla(177,66%,80%,1)",
	'bc_info-lightest':"border-color:hsla(177,100%,95%,1)",

	'bc_success-darkest':"border-color:hsla(149,50%,21%,1)",
	'bc_success-darker':"border-color:hsla(135,53%,31%,1)",
	'bc_success-dark':"border-color:hsla(135,50%,41%,1)",
	'bc_success':"border-color:hsla(135,50%,52%,1)",
	'bc_success-light':"border-color:hsla(138,56%,67%,1)",
	'bc_success-lighter':"border-color:hsla(135,66%,80%,1)",
	'bc_success-lightest':"border-color:hsla(137,80%,94%,1)",


	'bc-warning-darkest':"border-color:hsla(47,100%,18%,1)",
	'bc-warning-darker':"border-color:hsla(47,100%,27%,1)",
	'bc-warning-dark':"border-color:hsla(48,75%,45%,1)",
	'bc-warning':"border-color:hsla(46,86%,63%,1)",
	'bc-warning-light':"border-color:hsla(47,89%,78%,1)",
	'bc-warning-lighter':"border-color:hsla(47,91%,91%,1)",
	'bc-warning-lightest':"border-color:hsla(45,100%,98%,1)",

	'bc-danger-darkest':"border-color:hsla(2,62%,23%,1)",
	'bc-danger-darker':"border-color:hsla(3,71%,31%,1)",
	'bc-danger-dark':"border-color:hsla(4,75%,40%,1)",
	'bc-danger':"border-color:hsla(3,69%,51%,1)",
	'bc-danger-light':"border-color:hsla(2,67%,63%,1)",
	'bc-danger-lighter':"border-color:hsla(2,74%,81%,1)",
	'bc-danger-lightest':"border-color:hsla(0,70%,95%,1)",
}